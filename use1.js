window["__f__lfgl0v16.d6b"] = function(){with (this) {(async (u, { p, r, s }) => {try {r(u, s, [undefined,undefined,undefined,p.GM_info,p.GM_xmlhttpRequest,p.GM_openInTab,p.GM_notification,p.GM_addStyle,p.GM_getValue,p.GM_setValue,p.unsafeWindow,p.GM]);} catch (e) {if (e.message && e.stack) {console.error("ERROR: Execution of script 'GitToolPlus-Gitlab' failed! " + e.message);console.log(e.stack);} else {console.error(e);}}})(async function(define,module,exports,GM_info,GM_xmlhttpRequest,GM_openInTab,GM_notification,GM_addStyle,GM_getValue,GM_setValue,unsafeWindow,GM) {
    // ==UserScript==
    // @icon         http://pic04.somedomaindemoimg.com/img/common/136x136.png
    // @name         GitToolPlus-Gitlab
    // @namespace    http://www.somedomaindemo.com/
    // @version      4.10.5.2
    ...
    // @include      http://gitool.plt.somedomaindemo-inc.com/*
    // @grant        GM_info
    ...
    // @grant        GM_getValue
    // @grant        GM_setValue
    // @connect      gitlab.somedomaindemo-inc.com
    ...
    (function () {
        ...
        var url_arr = window.location.pathname.split('/'),
            ...
            eventUrl = 'https://gitlab.somedomaindemo-inc.com/index/gitool/event',
            getTaskListUrl = 'https://gitlab.somedomaindemo-inc.com/index/gitool/lists',
            dingTokenList = {},
            ...
            gitlabConfig = {
                ...
                baseHost: 'http://gitlab.somedomaindemo-inc.com',
                uris: {
        ...
        function init() {
            ...
            icon.append($('<img>').attr('src', 'http://pic04.somedomaindemoimg.com/img/common/136x136.png').css({ width: '100%', cursor: 'pointer' }));
            ...
            icon.find('img').click(function () {
                GM_openInTab('http://space.somedomaindemo-inc.com/display/salesproduct/GitToolPlus-Gitlab');
            });
            ...
            if (status == 'new_task') {
                ...
                getTaskList(userName, function (res) {
                    ...
                    for (var k in list) {
                        ...
                        var href = 'http://gitool.plt.somedomaindemo-inc.com/gitool/task_detail?branch_id=';
                        if (list[k].type == 'docker') {
                            href = 'http://gitool.plt.somedomaindemo-inc.com/dockertool/task_detail?branch_id=';
                        }
    ...
    //# sourceURL=chrome-extension://dhdgffkkebhmkfjojejmpbldmpobfkfo/userscript.html?name=GitToolPlus-Gitlab.user.js&id=85723f54-e3d3-47a0-99f1-116ed62e1bd9
    }